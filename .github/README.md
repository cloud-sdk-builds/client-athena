...
[`@aws-sdk/client-athena`](https://www.npmjs.com/package/@aws-sdk/client-athena/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-athena@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G8cjfAsU7EWeeDiUKfpuOM4AaG7Ls/Vb6js/BMIw147+orzOL2omv+veMrWnvEoG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-athena": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-athena@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-athena@3.986.0/index.min.mjs": "sha384-G8cjfAsU7EWeeDiUKfpuOM4AaG7Ls/Vb6js/BMIw147+orzOL2omv+veMrWnvEoG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-athena/blob/refs/tags/3.986.0/LICENSE
```
