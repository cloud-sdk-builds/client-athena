...
[`@aws-sdk/client-athena`](https://www.npmjs.com/package/@aws-sdk/client-athena/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-athena@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LRRtxX6cI0HAAKE71pZdt+AGQWApUQFHbq86cGkb9PhPGBswDAAAeJvV5WIO9gR1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-athena": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-athena@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-athena@3.168.0/index.min.mjs": "sha384-LRRtxX6cI0HAAKE71pZdt+AGQWApUQFHbq86cGkb9PhPGBswDAAAeJvV5WIO9gR1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-athena/blob/refs/tags/3.168.0/LICENSE
```
