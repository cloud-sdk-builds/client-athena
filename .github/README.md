...
[`@aws-sdk/client-athena`](https://www.npmjs.com/package/@aws-sdk/client-athena/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-athena@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ElcBQ1J99lj+DyxeM3ZXmv5PCoE1MOoHENx36jY1v1RtlTuft9qQMZUivco35EsN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-athena": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-athena@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-athena@3.435.0/index.min.mjs": "sha384-ElcBQ1J99lj+DyxeM3ZXmv5PCoE1MOoHENx36jY1v1RtlTuft9qQMZUivco35EsN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-athena/blob/refs/tags/3.435.0/LICENSE
```
